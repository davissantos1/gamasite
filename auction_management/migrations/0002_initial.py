...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='othergoods',
            name='imagens',
            field=models.ManyToManyField(related_name='other_goods_img', to='auction_management.itemimage', verbose_name='Imagens do Item'),
        ),
        migrations.AddField(
            model_name='othergoods',
            name='leilao',
        ...
        migrations.AddField(
            ...
            name='other_goods',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='other_goods_images', to='auction_management.othergoods', verbose_name='Outros Bens'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='realestate',
            name='imagens',
            field=models.ManyToManyField(related_name='real_estate_img', to='auction_management.itemimage', verbose_name='Imagens do Imóvel'),
        ),
        migrations.AddField(
            model_name='realestate',
            name='leilao',
        ...
        migrations.AddField(
            model_name='itemimage',
            name='real_estate',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='real_estate_images', to='auction_management.realestate', verbose_name='Imóvel'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='ruralitem',
            name='imagens',
            field=models.ManyToManyField(related_name='rural_item_img', to='auction_management.itemimage', verbose_name='Imagens do Item Rural'),
        ),
        migrations.AddField(
            model_name='ruralitem',
            name='leilao',
        ...
        migrations.AddField(
            model_name='itemimage',
            name='rural_item',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rural_item_images', to='auction_management.ruralitem', verbose_name='Item Rural'),
        ),
        migrations.AddField(
            model_name='vehicle',
            name='bids',
        ...
        migrations.AddField(
            model_name='vehicle',
            name='imagens',
            field=models.ManyToManyField(related_name='vehicles_img', to='auction_management.itemimage', verbose_name='Imagens do Veículo'),
        ),
        migrations.AddField(
            model_name='vehicle',
            name='leilao',
        ...
        migrations.AddField(
            model_name='itemimage',
            name='vehicle',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vehicle_images', to='auction_management.vehicle', verbose_name='Veículo'),
        ),
    ]
